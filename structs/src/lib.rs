...
use uuid::Uuid;
pub static MAP: LazyLock<HashMap<Uuid, Country>> = LazyLock::new(|| {
...
pub enum ResponseDTO {
    ...
    UpdateState {
        statuses: Vec<CStatus>,
    },
    UpdateRoom {
        room_id: Uuid,
        players: HashMap<Uuid, Player>,
        statuses: HashMap<Uuid, CStatus>,
    },
    GameStarted {
        room: RoomMaster,
        starter: Uuid,
...
//     exe: Arc<dyn Fn(Uuid,HashMap<Uuid, CStatus>) -> bool + Send + Sync>,
// }
